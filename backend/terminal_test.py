...
from backend.timesheet import get_timesheet_data, fetch_report, format_timesheet
...
def get_timesheet_data():
    ...
    return format_timesheet(today_data, "Today") + "\n\n" + format_timesheet(yesterday_data, "Yesterday")
